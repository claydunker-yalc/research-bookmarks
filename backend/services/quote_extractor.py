...
def extract_quotes(article_text: str, article_title: str, author: str = None) -> list[dict]:
    """
    Extract 3-5 notable, quotable passages from an article.

    Looks for:
    - Strong claims or provocative statements
    - Memorable, well-crafted lines
    - Key insights that stand alone
    - 2-4 sentences each
...
- Strong claims or provocative statements ("Students aren't cheating—they're revealing...")
...
JSON array:"""
    ...
    try:
        ...
        return valid_quotes[:5]  # Max 5 quotes
